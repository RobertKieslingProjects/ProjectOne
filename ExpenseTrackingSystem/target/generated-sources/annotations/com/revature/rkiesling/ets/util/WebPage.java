package com.revature.rkiesling.ets.util;

import com.revature.rkiesling.ets.util.InvoiceTable;
    ...
    static String addUserForm =
        "<div class=\"d-grid gap-3 p-2 border border-dark bg-primary text-gray\">" 
          + "<form action=\"AddEmployee\" method=\"POST\">"
            ...
            + "</div>"
            + "<div class=\"form-group mx-auto " + formInputPad + "\">"
              + "<input placeholder=\"E-Mail Address\" size=" + adminInputSize + "class=\"form-control\" name=\"email\" id=\"email\">"
            + "</div>"
            + "<div class=\"form-group mx-auto " + formInputPad + "\">"
